...
alias FValue = String | Int32 | Float32 | Bool |  Nil | Array(FValue)
...
alias ArgumentValue = String | Int32 | Float32 | Bool | InputObject | Array(ArgumentValue)
...
class ObjectTypeDefinition < AbstractNode
  values({name: String, interfaces: Array(CLTK::Token), fields: Array(Field), directives: Array(Directive), description: String})
...
class FieldDefinition < AbstractNode
  values({name: String, arguments: Array(Argument), type: Type, directives: Array(Directive), description: String})
